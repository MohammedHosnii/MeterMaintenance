...
{
    public partial class MaintenanceRecordForm_ONLine : Form
    {
        ...
        public MaintenanceRecordForm_ONLine()
        {
            InitializeComponent();
            
        }

        private async void MaintenanceRecordForm_ONLine_Load(object sender, EventArgs e)
        {
